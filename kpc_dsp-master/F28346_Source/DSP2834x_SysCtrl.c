...
#include "..\F28346_Include\DSP2834x_Device.h"     // Headerfile Include File
#include "..\F28346_Include\DSP2834x_Examples.h"   // Examples Include File
...
//   SysCtrlRegs.LOSPCP.all = 0x0001; //ksk
   SysCtrlRegs.LOSPCP.all = 0x0001;   //bds
